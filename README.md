...
## Overview
This is a Flask web application for flight price prediction. 
...
* Use a XGBoost Model for prediction
* Optimize the entire pipeline
* Use React.js for the front end to make it more responsive 
